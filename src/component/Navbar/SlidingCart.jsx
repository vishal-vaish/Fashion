...
const CartMain = ({ cart, addProductQuantity, removeFromCart}) => {
...
const CartProducts = ({ product, addProductQuantity, removeFromCart}) => {
...
const CartCheckOut = ({cart, toggleShowCart}) => {
